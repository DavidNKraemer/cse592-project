...
'''
Stochastic Quasi Newton (SQN) optimizer
'''
...
class SQN(Optimizer):
    def __init__(self, alpha=100, mem_size=10, batch_size=1, step_size=1., 
            use_locking=False, name='SQN'):
        '''
        constructs a new SQN optimizer
        '''
        super(SQN, self).__init__(use_locking, name)
        self._alpha = alpha
    ...
    def _create_slots(self, var_list):
        # var_list is any collection of features or other useful data
        for v in var_list:
    ...
    def _apply_dense(self, grad, var):
        # this is where we implement SQN
        # warning: gradients are the COORDINATES of the gradient
        # TODO : implement
        #
